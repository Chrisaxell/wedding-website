    ...
    return (
        <Tabs defaultValue="dresscode" className="w-full">
            ...
            <TabsContent value="dresscode" className="mt-4 space-y-3">
                <p className="text-sm whitespace-pre-line text-zinc-600">{t('INFO_DRESSCODE_DESC')}</p>
            ...
            <TabsContent value="parking" className="mt-4 space-y-3">
                <p className="text-sm whitespace-pre-line text-zinc-600">{t('INFO_PARKING_DESC')}</p>
            </TabsContent>
        </Tabs>
    );
}

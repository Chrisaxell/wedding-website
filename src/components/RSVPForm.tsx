...
export default function RSVPForm({ inviteId }: { inviteId?: string }) {
    ...
    return (
        ...
        >
            ...
            <label className="grid gap-1 text-sm">
                Email
                <input name="email" type="email" placeholder="you@example.com" className="rounded border px-2 py-1" />
            </label>
            <label className="grid gap-1 text-sm">
                Phone
                <input name="phone" type="tel" placeholder="+1 234 567 8900" className="rounded border px-2 py-1" />
            </label>
            <label className="grid gap-1 text-sm">
            ...
            <p className="text-xs text-zinc-500">Provide at least email or phone so we can send updates.</p>
